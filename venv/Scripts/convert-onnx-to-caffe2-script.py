...
# EASY-INSTALL-ENTRY-SCRIPT: 'torch==1.3.1+cpu','console_scripts','convert-onnx-to-caffe2'
...
if __name__ == '__main__':
    ...
    sys.exit(
        load_entry_point('torch==1.3.1+cpu', 'console_scripts', 'convert-onnx-to-caffe2')()
    )
